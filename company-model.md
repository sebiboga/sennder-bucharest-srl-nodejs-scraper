...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "sennder") |
| group        | string   | Parent company group (e.g. "sennder GmbH") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/sennder-bucharest-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)